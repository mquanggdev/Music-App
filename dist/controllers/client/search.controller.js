...
var result = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var type, keyword, unidecodeText, keywordSlug, keyWordSlugRegex, keyWordRegex, songs, songDetail, _i, songs_1, item, singer;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                type = req.params.type;
                keyword = "".concat(req.query.keyword);
                unidecodeText = (0, unidecode_1.default)(keyword.trim());
